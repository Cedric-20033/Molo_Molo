...
<head>
    ...
    <title>MOLO MOLO - inscription</title>
    ...
    <div class="container-fluid">
        <div class="row no-gutter">
            ...
            <div class="col-md-6 bg-light">
                <div class="signup d-flex aligns-items-center py-5">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-10 col-xl-7 mx-auto">
                                ...
                                <form action="" method="post" class="form-signup">
                                    ...
                                    <input type="reset" value="effacer" class="btn btn-secondary btn-block text-uppercase mb-2 rounded-pill shadow-sm">
                                        <button type="submit" class="btn btn-primary btn-block text-uppercase mb-2 rounded-pill shadow-sm">inscription</button>
                                </form>
                            </div>
                        </div>
                    </div>
